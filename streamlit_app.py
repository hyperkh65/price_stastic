...
if 'query' in st.session_state and st.session_state['query']:
    ...
    # 전용면적 데이터 처리
    selected_data = selected_data[selected_data['전용면적'].notnull()]

    # 데이터 표로 표시
    st.write("### 조회 결과")
    st.dataframe(selected_data.style.set_table_attributes('style="width:100%; background-color: #f9f9f9; border-radius: 5px;"'))
    ...
    st.sidebar.write("데이터를 조회하려면 위에 정보를 입력하고 '데이터 조회' 버튼을 클릭하세요.")
